...
{
    public class PostOrderTraversalTestsWithOneStack
    {
        [Fact]
        public void Basic()
        {
            ...
            var postOrderList = traverser.PostOrderNonRecursiveWithOneStacks(node1);
        ...
        public void Balanced()
        {
            ...
            var traverser = new BinaryTreeTraversal<int>();
            var postOrderList = traverser.PostOrderNonRecursiveWithOneStacks(node2);
        ...
        public void Left_chain()
        {
            ...
            var traverser = new BinaryTreeTraversal<int>();
            var postOrderList = traverser.PostOrderNonRecursiveWithOneStacks(node3);
